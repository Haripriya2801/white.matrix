    ...
    return (
        <>
            <section style={{ 
                ...
                alignItems: 'center', 
                height: '100vh', 
                backgroundColor: 'rgb(50, 50, 50)' // Dark grey background
            }}>
                <div className="container mt-5" style={{ backgroundColor: 'white', borderRadius: '10px', padding: '2rem', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
                    <div className="signup-content">
                        <div className="signup-form row">
                            <div className="signup-image col-md-6">
                                <figure>
                                    <img src={login} alt="not found" style={{ width: '100%' }} />
                                </figure>
