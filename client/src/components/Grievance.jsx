        ...
        <>
            <div className="contact_form_container">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6"> {/* Adjusted column size to align to the left */}
                                ...
                                <form method="POST" className='jumbotron'>
                                    <div className="contact_form_name d-flex row">
                                        <input type="text"
                                            ...
                                            className="contact_form_name input_field col-12"
                                            name="name"
                                        ...
                                        <input type="email"
                                            ...
                                            className="contact_form_email input_field col-12 mt-3"
                                            name="email"
                                        ...
                                        <input type="text"
                                            ...
                                            className="contact_form_contact input_field col-12 mt-3"
                                            name="phone"
                                    ...
                                    <br />
                                    <label htmlFor="complaint">Choose a department:</label>
                                    <select name="dept" id="complaint" className="form-select" onChange={handleInputs}>
                                    ...
                                    <div className="contact_form_text">
                                        <textarea className="text_field contact_form_message" id="msg"
                                            cols="30" rows="5" placeholder="Your Message Here" name="grievance"
