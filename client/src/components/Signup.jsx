...
const Signup = () => {
  ...
  return (
    <div style={{ 
        ...
        alignItems: 'center', 
        height: '100vh', 
        backgroundColor: 'rgb(255, 182, 182)' // Light red background
    }}>
                ...
                <form method="POST" className="register-form" id="register-form">
                  <div className="form-group">
                    ...
                    <input type="text" name="name" id="name" autoComplete="off"
                      ...
                      placeholder="Your name here" className='col-10' />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input type="email" name="email" id="email" autoComplete="off"
                      value={user.email}
                      onChange={handleInputs}
                      placeholder="Your email ID here" className='col-10' />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input type="password" name="password" id="password" autoComplete="off"
                      value={user.password}
                      onChange={handleInputs}
                      placeholder="Enter your password" className='col-10' />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input type="password" name="cpassword" id="cpassword" autoComplete="off"
                      ...
                      onChange={handleInputs}
                      placeholder="Re-enter your password" className='col-10' />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" name="phone" id="phone" autoComplete="off"
                      value={user.phone}
                      onChange={handleInputs}
                      placeholder="Your phone number here" className='col-10' />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" name="address" id="address" autoComplete="off"
                      value={user.address}
                      onChange={handleInputs}
                      placeholder="Your address" className='col-10' />
                  </div>
